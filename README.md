...
- Requests proxy to `ORIGIN_URL`.
- Tracking is scheduled in the background.
- Tracking failures do not break the proxied page.
- Origin failures return `502`.
- Proxy loops are rejected before any fetch.
